...
WIDTH = HEIGHT = 512  # could try 400 as well
DIMENSION = 8  # dimensions of the chessboard are 8x8
...
def main():
    ...
    sqSelected = ()  # no square is initially selected, keep track of the last click of the user (tuple: (row, col))
